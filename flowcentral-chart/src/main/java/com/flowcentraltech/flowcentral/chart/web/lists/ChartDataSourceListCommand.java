...
/**
 * Chart datasource list command.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@Component("chartdatasourcelist")
public class ChartDataSourceListCommand extends AbstractZeroParamsListCommand {
    ...
    public List<? extends Listable> execute(Locale locale, ZeroParams param) throws UnifyException {
        ...
        for (ChartDataSource chart : chartModuleService
                .findChartDataSources((ChartDataSourceQuery) new ChartDataSourceQuery()

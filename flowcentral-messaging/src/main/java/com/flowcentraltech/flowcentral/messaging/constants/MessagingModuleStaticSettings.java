...
/**
 * Messaging module static settings.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@AutoDetect
public class MessagingModuleStaticSettings extends AbstractFlowCentralStaticSettings {

    public MessagingModuleStaticSettings() {
        super(MessagingModuleNameConstants.MESSAGING_MODULE_SERVICE, "config/messaging-module.xml",
                "com.flowcentraltech.flowcentral.resources.messaging-messages",

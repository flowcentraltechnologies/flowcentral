...
public interface OSStreamingProcessor<T extends BaseOSMessagingResp> extends FlowCentralComponent {
    ...
    /**
     * Processes request input stream.
     * 
     * @param headers
     *                    the request headers
     * @param disposition
     *                    the stream disposition
     * @param in
     *                    the input stream
     ...
     *                        if an error occurs
     */
    T process(HttpRequestHeaders headers, ContentDisposition disposition, InputStream in) throws UnifyException;

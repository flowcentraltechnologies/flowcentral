...
/**
 * Convenient abstract base class for os messaging module list commands.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
public abstract class AbstractOSMessagingListCommand<T extends ListParam> extends AbstractFlowCentralListCommand<T> {

    @Configurable
    private OSMessagingModuleService osMessagingModuleService;

    public AbstractOSMessagingListCommand(Class<T> paramType) {
        super(paramType);
    }

    protected OSMessagingModuleService osmessaging() {

...
public abstract class AbstractOSUploadProcessor<T extends BaseOSMessagingResp> extends AbstractFlowCentralComponent
    ...
    @Override
    public T process(HttpRequestHeaders headers, ContentDisposition disposition, InputStream in) throws UnifyException {
        return doProcess(headers, disposition, in);
    }

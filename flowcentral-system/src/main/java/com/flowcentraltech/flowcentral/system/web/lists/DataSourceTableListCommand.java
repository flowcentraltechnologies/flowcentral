...
/**
 * Data source table list command.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@Component("datasourcetablelist")
public class DataSourceTableListCommand extends AbstractSystemListCommand<StringParam> {

    public DataSourceTableListCommand() {
    ...
    public List<? extends Listable> execute(Locale locale, StringParam params) throws UnifyException {
        if (params.isPresent()) {
            return system().findDataSourceTables(params.getValue());
        }

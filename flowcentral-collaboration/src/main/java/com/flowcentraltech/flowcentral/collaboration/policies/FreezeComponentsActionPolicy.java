...
/**
 * Freeze components action policy.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@Component("freezecomponents-actionpolicy")
public class FreezeComponentsActionPolicy extends AbstractEntityListActionPolicy {

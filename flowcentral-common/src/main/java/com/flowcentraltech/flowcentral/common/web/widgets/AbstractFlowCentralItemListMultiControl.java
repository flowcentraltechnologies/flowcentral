...
/**
 * Convenient abstract base class for flowcentral item list multi-control widgets.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
public abstract class AbstractFlowCentralItemListMultiControl<T> extends AbstractItemListMultiControl<T> {

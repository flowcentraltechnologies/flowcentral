...
public class NotifMessage {
    ...
    public static class Builder {
        ...
        public Builder addAttachment(FileAttachmentType type, String name, String title, String fileName,
                String provider, String sourceId) {
            attachments.add(Attachment.newBuilder(type).name(name).title(title).fileName(fileName)
        ...
        public Builder addAttachment(FileAttachmentType type, String name, String title, String provider,
                String sourceId) {
            attachments.add(Attachment.newBuilder(type).name(name).title(title).source(provider, sourceId).build());
            return this;
        }

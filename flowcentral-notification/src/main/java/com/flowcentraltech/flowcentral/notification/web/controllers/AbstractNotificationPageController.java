...
/**
 * Convenient abstract base class for notification module page controllers.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
public abstract class AbstractNotificationPageController<T extends AbstractPageBean>
        extends AbstractFlowCentralPageController<T> {

    @Configurable
    private NotificationModuleService notificationModuleService;

    public AbstractNotificationPageController(Class<T> pageBeanClass, Secured secured, ReadOnly readOnly,
            ResetOnWrite resetOnWrite) {
        super(pageBeanClass, secured, readOnly, resetOnWrite);
    }

    protected NotificationModuleService notification() {

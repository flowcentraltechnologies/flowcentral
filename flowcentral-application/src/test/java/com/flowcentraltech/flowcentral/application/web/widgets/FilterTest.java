...
public class FilterTest extends AbstractFlowCentralTest {
    ...
    public void testBlankFilter() throws Exception {
        Filter fo = new Filter(au, null, null, getEntityDef(), labelSuggestionDef, false, false, "application.sessionparamtypelist",
    ...
    protected EntityDef getEntityDef() throws Exception {
        if (ed == null) {
            au.setAdhocWidgetTypeDef(DataType.DOUBLE, InputType.DOUBLE, "application.amount", "Amount",
                    "!ui-decimal precision:14 scale:2", "!ui-label");
            au.setAdhocWidgetTypeDef(DataType.STRING, InputType.STRING, "application.text", "Text", "!ui-text",
                    "!ui-label");
            ...
            ed = EntityDef
                    ...
                    .addFieldDef("application.text", "application.text", EntityFieldDataType.STRING,
                            EntityFieldType.STATIC, "description", "Description")

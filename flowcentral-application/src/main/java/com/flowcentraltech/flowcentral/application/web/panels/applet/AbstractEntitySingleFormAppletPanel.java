	...
	public void switchState() throws UnifyException {
		...
		case NEW_FORM:
			...
			if (enableCreate) {
				...
				setVisible("saveCloseBtn",
						_appletDef.getPropValue(boolean.class, AppletPropertyConstants.CREATE_FORM_SAVE_CLOSE, false));
				setVisible("submitCloseBtn", enableCreateSubmit
						&& _appletDef.getPropValue(boolean.class, AppletPropertyConstants.CREATE_FORM_SUBMIT, false));

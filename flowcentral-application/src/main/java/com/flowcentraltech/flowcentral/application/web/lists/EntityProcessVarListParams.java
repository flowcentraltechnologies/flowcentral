...
/**
 * Entity definition and process variable list parameters.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
public class EntityProcessVarListParams extends AbstractListParam {

    private EntityDef entityDef;

    private boolean includeProcessVariable;
 
    public EntityProcessVarListParams(EntityDef entityDef, boolean includeProcessVariable) {

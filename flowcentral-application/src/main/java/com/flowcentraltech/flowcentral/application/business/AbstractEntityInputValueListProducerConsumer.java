...
/**
 * Convenient abstract base class for entity input value list
 * producer-consumers.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
public abstract class AbstractEntityInputValueListProducerConsumer extends AbstractFlowCentralComponent

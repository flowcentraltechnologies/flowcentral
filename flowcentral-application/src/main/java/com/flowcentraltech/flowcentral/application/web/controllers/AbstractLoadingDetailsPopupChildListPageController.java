...
/**
 * Convenient abstract base class for loading detail popup child list
 * controllers.
 * 
...
public abstract class AbstractLoadingDetailsPopupChildListPageController<T extends AbstractLoadingDetailsPageBean>
    ...
    public AbstractLoadingDetailsPopupChildListPageController(Class<T> pageBeanClass, Secured secured,

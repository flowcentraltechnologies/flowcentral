...
public class AppTableLoadingQuery extends BaseConfigNamedEntityQuery<AppTableLoading> {
    ...
    public AppTableLoadingQuery() {
        super(AppTableLoading.class);
    }

    public AppTableLoadingQuery appTableId(Long appTableId) {
        return (AppTableLoadingQuery) addEquals("appTableId", appTableId);
    }
}

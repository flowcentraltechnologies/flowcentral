...
/**
 * Static list external accessibility provider.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
public interface StaticListExternalAccessibilityProvider extends FlowCentralComponent {

    /**
     * Checks if a static list enumeration is stale.
     * 
     * @param longName
     *                       the static list name
    ...
    /**
     * Gets static list enumeration definition.
     * 
     * @param longName
     *                 the static list name

...
/**
 * Email producer-consumer list command.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@Component("emailproducerconsumerlist")
public class EmailProducerConsumerListCommand extends AbstractFlowCentralTypeListCommand<EmailListProducerConsumer, ZeroParams> {

    public EmailProducerConsumerListCommand() {
        super(EmailListProducerConsumer.class, ZeroParams.class);
    }

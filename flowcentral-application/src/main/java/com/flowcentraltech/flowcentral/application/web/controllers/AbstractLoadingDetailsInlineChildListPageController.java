...
/**
 * Convenient abstract base class for loading detail inline child list
 * controllers.
 * 
...
public abstract class AbstractLoadingDetailsInlineChildListPageController<T extends AbstractLoadingDetailsPageBean>
    ...
    public AbstractLoadingDetailsInlineChildListPageController(Class<T> pageBeanClass, Secured secured,

...
/**
 * Application property sequence entity.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@Table(name = "FC_PROPERTYSEQUENCE", indexes = { @Index(value = { "entity" }), @Index(value = { "category" }) })
public class AppPropertySequence extends BaseAuditEntity {
    ...
    @CategoryColumn(name = "SEQUENCE_CAT")
    private String category;

    @Column(type = ColumnType.CLOB, name = "SEQUENCE_DEF", nullable = true)
    private String definition;

    public AppPropertySequence(String definition) {
        this.definition = definition;
    }

    public AppPropertySequence() {

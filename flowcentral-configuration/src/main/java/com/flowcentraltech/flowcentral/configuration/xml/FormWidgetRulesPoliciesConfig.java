...
/**
 * Form widget rules policies configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class FormWidgetRulesPoliciesConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "formWidgetRulesPolicy")
    private List<FormWidgetRulesPolicyConfig> widgetRulesPolicyList;

    public FormWidgetRulesPoliciesConfig(List<FormWidgetRulesPolicyConfig> widgetRulesPolicyList) {
        this.widgetRulesPolicyList = widgetRulesPolicyList;
    }

    public FormWidgetRulesPoliciesConfig() {

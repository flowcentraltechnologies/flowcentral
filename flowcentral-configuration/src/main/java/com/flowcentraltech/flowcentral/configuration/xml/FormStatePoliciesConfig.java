...
/**
 * Form state policies configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class FormStatePoliciesConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "formStatePolicy")
    private List<FormStatePolicyConfig> formStatePolicyList;

    public FormStatePoliciesConfig(List<FormStatePolicyConfig> formStatePolicyList) {
        this.formStatePolicyList = formStatePolicyList;
    }

    public FormStatePoliciesConfig() {

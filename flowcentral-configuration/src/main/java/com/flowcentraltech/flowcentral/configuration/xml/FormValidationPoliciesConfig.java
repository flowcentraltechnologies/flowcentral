...
/**
 * Form validation policies configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class FormValidationPoliciesConfig {
    ...
    public FormValidationPoliciesConfig(List<FormValidationPolicyConfig> formValidationPolicyList) {
        this.formValidationPolicyList = formValidationPolicyList;
    }

    public FormValidationPoliciesConfig() {

...
/**
 * Table quick filters configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class TableQuickFiltersConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "quickFilter")
    private List<FilterConfig> quickFilterList;

    public TableQuickFiltersConfig(List<FilterConfig> quickFilterList) {
        this.quickFilterList = quickFilterList;
    }

    public TableQuickFiltersConfig() {

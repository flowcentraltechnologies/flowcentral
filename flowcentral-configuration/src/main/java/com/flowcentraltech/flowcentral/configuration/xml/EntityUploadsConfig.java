...
/**
 * Entity uploads configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class EntityUploadsConfig extends BaseConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "upload")
    private List<EntityUploadConfig> uploadList;

    public EntityUploadsConfig(List<EntityUploadConfig> uploadList) {
        this.uploadList = uploadList;
    }

    public EntityUploadsConfig() {

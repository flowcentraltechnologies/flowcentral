...
/**
 * Entity expressions configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class EntityExpressionsConfig extends BaseConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "expression")
    private List<EntityExpressionConfig> expressionList;

    public EntityExpressionsConfig(List<EntityExpressionConfig> expressionList) {
        this.expressionList = expressionList;
    }

    public EntityExpressionsConfig() {

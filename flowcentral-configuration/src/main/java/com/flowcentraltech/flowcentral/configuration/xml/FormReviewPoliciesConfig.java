...
/**
 * Form review policies configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class FormReviewPoliciesConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "formReviewPolicy")
    private List<FormReviewPolicyConfig> formReviewPolicyList;

    public FormReviewPoliciesConfig(List<FormReviewPolicyConfig> formReviewPolicyList) {
        this.formReviewPolicyList = formReviewPolicyList;
    }

    public FormReviewPoliciesConfig() {

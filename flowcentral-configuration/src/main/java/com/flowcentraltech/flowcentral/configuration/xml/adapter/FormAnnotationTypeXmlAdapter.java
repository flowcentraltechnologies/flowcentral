 ...
 * @since 4.1
 */
public class FormAnnotationTypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<FormAnnotationType> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<FormAnnotationType> {

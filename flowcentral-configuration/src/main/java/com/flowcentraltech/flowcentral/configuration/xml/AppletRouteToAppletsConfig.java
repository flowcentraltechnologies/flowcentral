...
/**
 * Applet route to applets configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class AppletRouteToAppletsConfig extends BaseConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "routeToAppletItem")
    private List<AppletRouteToAppletConfig> routeToAppletList;

    public AppletRouteToAppletsConfig(List<AppletRouteToAppletConfig> routeToAppletList) {
        this.routeToAppletList = routeToAppletList;
    }

    public AppletRouteToAppletsConfig() {

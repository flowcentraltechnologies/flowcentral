 ...
 * @since 4.1
 */
public class FormStatePolicyTypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<FormStatePolicyType> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<FormStatePolicyType> {

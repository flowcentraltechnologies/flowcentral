...
/**
 * Entity search inputs configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class EntitySearchInputsConfig extends BaseConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "searchInput")
    private List<EntitySearchInputConfig> searchInputList;

    public EntitySearchInputsConfig(List<EntitySearchInputConfig> searchInputList) {
        this.searchInputList = searchInputList;
    }

    public EntitySearchInputsConfig() {

...
/**
 * Notification large text installation configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
public class NotifLargeTextInstall {

    private NotifLargeTextConfig notifLargeTextConfig;

    public NotifLargeTextInstall(NotifLargeTextConfig notifLargeTextConfig) {

...
/**
 * Entity series set configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class EntitySeriesSetConfig extends BaseConfig {

    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "series")
    private List<EntitySeriesConfig> seriesList;

    public EntitySeriesSetConfig(List<EntitySeriesConfig> seriesList) {
        this.seriesList = seriesList;
    }

    public EntitySeriesSetConfig() {

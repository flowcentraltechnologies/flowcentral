...
/**
 * Workflow set values type XML adapter.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
public class WorkflowSetValuesTypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<WorkflowSetValuesType> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<WorkflowSetValuesType> {

        public Deserializer() {
            super(WorkflowSetValuesType.class);
        }

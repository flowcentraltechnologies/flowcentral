...
public class ChannelDirectionTypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    ...
    public static class Serializer extends AbstractEnumConstSerializer<ChannelDirectionType> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<ChannelDirectionType> {

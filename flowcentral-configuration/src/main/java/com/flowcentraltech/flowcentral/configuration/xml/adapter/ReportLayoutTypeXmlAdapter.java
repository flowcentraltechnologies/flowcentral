 ...
 * @since 4.1
 */
public class ReportLayoutTypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<ReportLayoutType> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<ReportLayoutType> {

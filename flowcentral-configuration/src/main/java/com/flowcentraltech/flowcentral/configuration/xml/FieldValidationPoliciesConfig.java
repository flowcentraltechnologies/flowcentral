...
/**
 * Form field validation policies configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class FieldValidationPoliciesConfig {
    ...
    public FieldValidationPoliciesConfig(List<FieldValidationPolicyConfig> fieldValidationPolicyList) {
        this.fieldValidationPolicyList = fieldValidationPolicyList;
    }

    public FieldValidationPoliciesConfig() {

...
/**
 * Dashboard columns type XML adapter.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
public class DashboardColumnsTypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<DashboardColumnsType> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<DashboardColumnsType> {

        public Deserializer() {
            super(DashboardColumnsType.class);
        }

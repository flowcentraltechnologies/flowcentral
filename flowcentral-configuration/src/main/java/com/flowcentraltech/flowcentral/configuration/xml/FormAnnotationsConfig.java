...
/**
 * Form annotations configuration.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@JsonInclude(value = Include.NON_NULL, content = Include.NON_EMPTY)
public class FormAnnotationsConfig {
    
    @JacksonXmlElementWrapper(useWrapping = false)
    @JacksonXmlProperty(localName = "annotation")
    private List<FormAnnotationConfig> annotationList;

    public FormAnnotationsConfig(List<FormAnnotationConfig> annotationList) {
        this.annotationList = annotationList;
    }

    public FormAnnotationsConfig() {

...
/**
 * Chart data source type XML adapter.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
public class ChartDataSourceTypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<ChartDataSourceType> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<ChartDataSourceType> {

        public Deserializer() {
            super(ChartDataSourceType.class);
        }

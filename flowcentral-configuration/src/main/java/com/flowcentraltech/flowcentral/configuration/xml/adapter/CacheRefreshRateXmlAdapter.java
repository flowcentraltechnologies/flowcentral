...
/**
 * Cache refresh rate XML adapter.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
public class CacheRefreshRateXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<CacheRefreshRate> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<CacheRefreshRate> {

        public Deserializer() {
            super(CacheRefreshRate.class);
        }

...
/**
 * Vertical alignment type XML adapter.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
public class VAlignTypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<VAlignType> {
        public Serializer() {
    ...
    public static class Deserializer extends AbstractEnumConstDeserializer<VAlignType> {

        public Deserializer() {
            super(VAlignType.class);
        }

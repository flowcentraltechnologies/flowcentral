...
/**
 * API type XML adapter.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
public class APITypeXmlAdapter extends AbstractEnumConstXmlAdapter {
    
    public static class Serializer extends AbstractEnumConstSerializer<APIType> {
        public Serializer() {
            
        }
    }
    
    public static class Deserializer extends AbstractEnumConstDeserializer<APIType> {
        public Deserializer() {
            super(APIType.class);
        }
    }

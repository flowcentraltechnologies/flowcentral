...
/**
 * Abstract end-point reader.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@Singleton(false)
public abstract class AbstractEndpointReader extends AbstractFlowCentralComponent implements EndpointReader {
    ...
    protected Endpoint getEndpoint(String endpointName) throws UnifyException {
        return endpointManager.getEndpoint(endpointName);
    }

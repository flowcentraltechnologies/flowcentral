...
/**
 * 
 * User creation approved email sender.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@EntityReferences({"security.user"})
@Component(name = "usercreation-approved", description = "User Welcome Email Sender")
public class UserCreationApprovedEmailSender extends AbstractResourceBundleNotificationAlertSender {

    public UserCreationApprovedEmailSender() {
        super(NotifType.EMAIL, "security.notification.userwelcome.subject",
                "security.notification.userwelcome.body");
    }

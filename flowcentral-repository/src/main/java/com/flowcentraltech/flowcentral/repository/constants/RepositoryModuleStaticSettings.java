...
/**
 * Repository module static settings.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@AutoDetect
public class RepositoryModuleStaticSettings extends AbstractFlowCentralStaticSettings {

    public RepositoryModuleStaticSettings() {
        super(RepositoryModuleNameConstants.REPOSITORY_MODULE_SERVICE, "config/repository-module.xml",
                "com.flowcentraltech.flowcentral.resources.repository-messages",

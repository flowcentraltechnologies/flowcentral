...
/**
 * Dashboard option query.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
public class DashboardOptionQuery extends BaseAuditEntityQuery<DashboardOption> {

    public DashboardOptionQuery() {
        super(DashboardOption.class);
    }

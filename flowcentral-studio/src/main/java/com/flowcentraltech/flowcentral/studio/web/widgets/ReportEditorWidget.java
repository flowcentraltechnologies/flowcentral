...
public class ReportEditorWidget extends AbstractFlowCentralMultiControl {
    ...
    public void setDesign(String design) throws UnifyException {
        if (!StringUtils.isBlank(design)) {
            getReportEditor().setDesign(jsonObjectStreamer.unmarshal(Design.class, design));
        }
    }
    ...
    public ReportEditor getReportEditor() throws UnifyException {
        return getValue(ReportEditor.class);
    }

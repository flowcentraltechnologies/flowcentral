...
/**
 * Studio widgets list command
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@Component("studiowidgetslist")
public class StudioWidgetsListCommand extends AbstractApplicationListCommand<ZeroParams> {

    public StudioWidgetsListCommand() {

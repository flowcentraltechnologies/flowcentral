...
public enum StudioAppComponentType implements EnumConst {
    ...
    REPOSITORY( 
            "rep_",
            null,
            "$m{studio.application.component.type.repository}",
            "$m{studio.application.component.type.repositories}",
            "studio.menu.label.repository",
            "archive",
            null,
            null,
            null,
    ...
    SYNCHRONIZATION( 
            ...
            "$m{studio.application.component.type.synchronizations}",
            "studio.menu.label.synchronization",
            "sync",
            null,
            null,
            null,
    ...
    SNAPSHOT( 
            "snp_",
            null,
            "$m{studio.application.component.type.snapshot}",
            "$m{studio.application.component.type.snapshots}",
            "studio.menu.label.snapshot",
            "camera",
            null,
            null,
            null,

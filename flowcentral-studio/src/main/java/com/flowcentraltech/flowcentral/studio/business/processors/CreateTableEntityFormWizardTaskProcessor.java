...
/**
 * Create table entity form wizard policies.
 * 
 * @author FlowCentral Technologies Limited
 * @since 4.1
 */
@EntityReferences({ "studio.studioJsonEntity" })
@Component("createtableentity-formwizardprocessor")
public class CreateTableEntityFormWizardTaskProcessor extends AbstractCreateEntityFormWizardTaskProcessor {

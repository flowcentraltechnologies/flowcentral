...
public class StudioJsonFormatterListCommand extends AbstractApplicationListCommand<DataTypeListParams> {
    ...
    public StudioJsonFormatterListCommand() {
        super(DataTypeListParams.class);
    }

    @Override
    public List<? extends Listable> execute(Locale locale, DataTypeListParams params) throws UnifyException {
        if (params.isPresent()) {
            return DataTypeUtils.getFormatterList(params.getDataType());
        }

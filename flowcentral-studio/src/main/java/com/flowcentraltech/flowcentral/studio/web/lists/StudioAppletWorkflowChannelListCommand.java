...
/**
 * Studio applet workflow channel list command
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@Component("studioappletworkflowchannellist")
public class StudioAppletWorkflowChannelListCommand extends AbstractApplicationListCommand<LongParam> {

    @Configurable
    private WorkflowModuleService workflowModuleService;

    public StudioAppletWorkflowChannelListCommand() {

...
/**
 * Studio applet set values list command
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@Component("studioappletsetvalueslist")
public class StudioAppletSetValuesListCommand extends AbstractApplicationListCommand<LongParam> {

    public StudioAppletSetValuesListCommand() {

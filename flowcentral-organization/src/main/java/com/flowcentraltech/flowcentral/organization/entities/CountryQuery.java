 ...
 * @since 1.0
 */
public class CountryQuery extends BaseStatusTenantEntityQuery<Country> {
    ...
    public CountryQuery iso3CodeLike(String iso3Code) {
        return (CountryQuery) addLike("iso3Code", iso3Code);
    }

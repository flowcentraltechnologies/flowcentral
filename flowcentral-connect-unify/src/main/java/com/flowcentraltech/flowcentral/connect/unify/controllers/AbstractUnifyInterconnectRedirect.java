 ...
 * @since 4.1
 */
public abstract class AbstractUnifyInterconnectRedirect extends AbstractUnifyComponent
        implements UnifyInterconnectRedirect {
    ...
    public AbstractUnifyInterconnectRedirect() {

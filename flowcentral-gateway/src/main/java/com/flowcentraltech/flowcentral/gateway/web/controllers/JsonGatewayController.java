...
/**
 * JSON Gateway Controller.
 * 
 * @author FlowCentral Technologies Limited
 * @since 1.0
 */
@Component("/flowcentral/gateway/json")
public class JsonGatewayController<T extends BaseGatewayResponse, U extends BaseGatewayRequest>
        extends AbstractPlainJsonController {

    @Override
    protected final Object doExecute(String json) throws UnifyException {
        // TODO
        return null;
    }
